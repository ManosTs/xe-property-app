    ...
    return <Card className={'bg-white'}>
        ...
        <CardContent>
            <div className="w-full overflow-x-auto">
                <Link to={'/ad-management'} className={'text-sm bg-blue-400 text-white rounded p-1'}>
                    Add Property
                </Link>
                            ...
                            >
                                ...
                                <td className={"p-3 text-sm"}>
                                    <div className="flex items-center justify-start gap-4">
                                        ...
                                        <CrossCircledIcon onClick={() => handleDelete(row?.id)} className={'w-5 h-5 cursor-pointer'} color={'red'} />
                                    </div>
                                </td>
                            </tr>
                        ))
